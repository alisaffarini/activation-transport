...
# === Main Experiment ===
def run_experiment(num_seeds=10):
    ...
    cnn1 = SimpleCNN()
    cnn2 = SimpleCNN()
    cnn1, _, _ = train_model(cnn1, train_loader, val_loader, device, max_epochs=15)
    cnn2, _, _ = train_model(cnn2, train_loader, val_loader, device, max_epochs=15)

...
\begin{enumerate}
    ...
    \item \textbf{ViT-Small.} A vision transformer (patch size 4, embedding dimension 192, 6 layers, 6 heads) with global self-attention. Final representation dimensionality: 192.
    \item \textbf{MLP-Mixer.} A purely MLP-based architecture with token-mixing and channel-mixing layers (patch size 4, dimension 192, 6 layers). Final representation dimensionality: 192.
